...
% assigned a 'correct' identity corresponding to a difqqferent subject in the
...
% all_default_se1 is M by N matrix, M is the number of edges in the whole connectivity matrix, 
...
for it = 1:N_iteration
    ...
    all_se2 = all_default_se2(:,sub_order);
